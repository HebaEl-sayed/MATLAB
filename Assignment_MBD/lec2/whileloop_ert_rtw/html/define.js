...
this.def["whileloop_DW"] = {file: "whileloop_c.html",line:22,type:"var"};
this.def["whileloop_U"] = {file: "whileloop_c.html",line:25,type:"var"};
this.def["whileloop_Y"] = {file: "whileloop_c.html",line:28,type:"var"};
this.def["whileloop.c:whileloop_M_"] = {file: "whileloop_c.html",line:31,type:"var"};
this.def["whileloop_M"] = {file: "whileloop_c.html",line:32,type:"var"};
this.def["whileloop_step"] = {file: "whileloop_c.html",line:35,type:"fcn"};
this.def["whileloop_initialize"] = {file: "whileloop_c.html",line:70,type:"fcn"};
this.def["whileloop_terminate"] = {file: "whileloop_c.html",line:80,type:"fcn"};
this.def["DW_whileloop_T"] = {file: "whileloop_h.html",line:39,type:"type"};
this.def["ExtU_whileloop_T"] = {file: "whileloop_h.html",line:45,type:"type"};
this.def["ExtY_whileloop_T"] = {file: "whileloop_h.html",line:50,type:"type"};
this.def["RT_MODEL_whileloop_T"] = {file: "whileloop_types_h.html",line:24,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["whileloop_c.html"] = "../whileloop.c";
	this.html2Root["whileloop_c.html"] = "whileloop_c.html";
	this.html2SrcPath["whileloop_h.html"] = "../whileloop.h";
	this.html2Root["whileloop_h.html"] = "whileloop_h.html";
	this.html2SrcPath["whileloop_private_h.html"] = "../whileloop_private.h";
	this.html2Root["whileloop_private_h.html"] = "whileloop_private_h.html";
	this.html2SrcPath["whileloop_types_h.html"] = "../whileloop_types.h";
	this.html2Root["whileloop_types_h.html"] = "whileloop_types_h.html";
...
var fileList = [
"ert_main_c.html","whileloop_c.html","whileloop_h.html","whileloop_private_h.html","whileloop_types_h.html","rtwtypes_h.html"];
